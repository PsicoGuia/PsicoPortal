# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-12-08 23:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('M', 'Masculino'), ('F', 'Femenino'), ('U', 'No definido')], default='U', max_length=1)),
                ('personalDocumentType', models.CharField(choices=[('CC', 'Cedula de ciudadania'), ('CE', 'Cedula de extranjeria'), ('PS', 'Pasaporte')], default='CC', max_length=2, verbose_name='Tipo de documento')),
                ('personalDocumentNumber', models.BigIntegerField(null=True, verbose_name='Numero de documento')),
                ('personalDocumentFile', models.ImageField(null=True, upload_to=medic.models.profileFilePath)),
                ('professionalCardNumber', models.CharField(max_length=25, null=True)),
                ('professionalCardFile', models.ImageField(null=True, upload_to=medic.models.profileFilePath)),
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency=b'COP', max_digits=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[('BH', 'Pregrado'), ('CR', 'Certificacion'), ('SP', 'Especializacion'), ('MS', 'Maestria'), ('PH', 'Doctorado')], default='BH', max_length=2)),
                ('title', models.CharField(max_length=100)),
                ('date', models.DateField()),
                ('experienceYears', models.IntegerField()),
                ('file', models.FileField(upload_to=medic.models.studiesFilePath)),
